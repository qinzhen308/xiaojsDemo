...
public class DragSortListView extends ListView {
    ...
    public boolean startDrag(int position, View floatView, int dragFlags, int deltaX, int deltaY) {
        ...
        if(mDragStateListener!=null){
            mDragStateListener.startDrag(position);
        }
    ...
    public void setDragStateListener(DragStateListener l) {
        mDragStateListener = l;
    }
    ...
    public interface DragSortListener extends DropListener, DragListener, RemoveListener ,DragStateListener {
    }
    ...
    public void hookChangeStartPosition(int position){
        mFloatPos=mSrcPos=position+getHeaderViewsCount();
    }
