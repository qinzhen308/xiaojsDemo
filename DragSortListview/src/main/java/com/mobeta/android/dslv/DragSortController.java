...
public class DragSortController extends SimpleFloatViewManager implements View.OnTouchListener, GestureDetector.OnGestureListener {
    ...
    public void flingTouch(MotionEvent ev){
...
//            mFlingRemoveDetector.onTouchEvent(ev);
//        }
        Log.d("drag","dsc--ontouch--action="+ev.getAction());
        int action = ev.getAction() & MotionEvent.ACTION_MASK;
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                mCurrX = (int) ev.getX();
                mCurrY = (int) ev.getY();
                Log.d("drag","dsc--ontouch--action down=("+mCurrX+","+mCurrY+")");
                break;
            case MotionEvent.ACTION_UP:
                ...
                Log.d("drag","dsc--ontouch--action up=("+mCurrX+","+mCurrY+")");
    ...
    public boolean onDown(MotionEvent ev) {
        Log.d("drag","dsc---ondown--mitem("+mItemX+","+mItemY+")  now"+ev.getX()+","+ev.getY()+")");
    ...
    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
        ...
        Log.d("drag","dsc---ondown--mitem("+mItemX+","+mItemY+")  delta("+deltaX+","+deltaY+")");
