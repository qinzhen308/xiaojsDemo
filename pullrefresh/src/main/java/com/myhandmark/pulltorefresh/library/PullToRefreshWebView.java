...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
	public OnscrollChangeLis onscrollChangeLis;
	...
	public void setOnscrollChangeLis(OnscrollChangeLis onscrollChangeLis) {
		this.onscrollChangeLis = onscrollChangeLis;
	}
	...
	final class InternalWebViewSDK9 extends WebView {
		...
		protected void onScrollChanged(int l, int t, int oldl, int oldt) {
			...
			if(onscrollChangeLis != null){
				onscrollChangeLis.Onscroll(l,t,oldl,oldt);
			}
	...
	public interface OnscrollChangeLis{
