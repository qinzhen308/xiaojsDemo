...
public class LetterIndexView extends View {
    ...
    public LetterIndexView(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
        ...
        this.offset = 0.0F;
        this.hit = false;
        this.normalColor = paramContext.getResources().getColor(R.color.index_blue);
        this.touchColor = Color.WHITE;

        hintDrawable = paramContext.getResources().getDrawable(R.drawable.letter_view_hit_point);
