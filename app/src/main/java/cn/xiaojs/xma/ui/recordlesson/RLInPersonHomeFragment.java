...
public class RLInPersonHomeFragment extends Fragment implements IUpdateMethod{
    ...
    private void filter() {
        ...
        dialog.setOnOkListener(new MyClassFilterDialog.OnOkListener() {
            ...
            public void onOk(int group1Position, int group2Position) {
                RLInPersonHomeFragment.this.group1Position = group1Position;
                RLInPersonHomeFragment.this.group2Position = group2Position;
