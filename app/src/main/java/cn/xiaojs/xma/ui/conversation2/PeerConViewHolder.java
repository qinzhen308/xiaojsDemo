...
public class PeerConViewHolder extends AbsConversationViewHolder {
    ...
    public static View createView(Context context, ViewGroup parent) {
        ...
        return inflater.inflate(R.layout.layout_conversation2_peer_conversation_item,parent,false);
    }
}
