...
public interface Transformation {
     ...
     * @param y 当前后按下的y坐标
     */
    public abstract void scale(float oldX, float oldY, float x, float y);
     ...
     * @param y 当前后按下的y坐标
     */
    public abstract void rotate(float oldX, float oldY, float x, float y);
     ...
     * @param y 当前后按下的y坐标
     */
    public abstract void scaleAndRotate(float oldX, float oldY, float x, float y);
