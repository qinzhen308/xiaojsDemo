...
/**
 * Created by maxiaobao on 2017/8/31.
 */

public class PlayActivity extends Activity implements EventListener,
        PlaybackControlView.VisibilityListener {

    public static final String EXTRA_PLAY_NAME = "play_name";
    public static final String DRM_SCHEME_UUID_EXTRA = "drm_scheme_uuid";
    public static final String DRM_LICENSE_URL = "drm_license_url";
    public static final String DRM_KEY_REQUEST_PROPERTIES = "drm_key_request_properties";
    public static final String PREFER_EXTENSION_DECODERS = "prefer_extension_decoders";

    public static final String ACTION_VIEW = "cn.xiaojs.xma.player.action.VIEW";
    public static final String EXTENSION_EXTRA = "extension";

    public static final String ACTION_VIEW_LIST = "cn.xiaojs.xma.player.action.VIEW_LIST";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String name = getIntent().getStringExtra(EXTRA_PLAY_NAME);
        nameView.setText(name);
    }

    @OnClick({R.id.root, R.id.retry_button, R.id.name_view})
    ...
    private DataSource.Factory buildDataSourceFactory(boolean useBandwidthMeter) {
        return ExoUtil.buildDataSourceFactory(this, useBandwidthMeter ? BANDWIDTH_METER : null);
    }
