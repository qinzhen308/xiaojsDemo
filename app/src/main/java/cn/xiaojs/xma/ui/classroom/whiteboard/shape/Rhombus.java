...
public class Rhombus extends TwoDimensionalShape {
    ...
    public Rhombus(Whiteboard whiteboard, Paint paint) {
        super(whiteboard, GeometryShape.RHOMBUS);
        setPaint(paint);
    }

    public Rhombus(Whiteboard whiteboard, Paint paint, String doodleId) {
        super(whiteboard, GeometryShape.RHOMBUS);
    ...
    public void onDrawSelf(Canvas canvas) {
        ...
        mDrawingPath.lineTo(mTransRect.centerX(),mTransRect.bottom);
    ...
    private ArrayList<PointF> getRealPoints(float transX, float transY, Matrix drawingMatrix){
        ...
        dest.add(new PointF(mDoodleRect.right,mDoodleRect.centerY()));
        dest.add(new PointF(mDoodleRect.centerX(),mDoodleRect.bottom));
