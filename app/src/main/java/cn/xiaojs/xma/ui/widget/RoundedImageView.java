...
public class RoundedImageView extends ImageView {
    ...
    public static final int GRAVITY_CENTER_VERTICAL = 1 << 6;
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mLabelOffsetLeft = Math.max(0, a.getDimensionPixelOffset(R.styleable.RoundedImageView_label_offsetleft, -1));
        mLabelOffsetRight = Math.max(0, a.getDimensionPixelOffset(R.styleable.RoundedImageView_label_offsetright, -1));
        mLabelOffsetTop = Math.max(0, a.getDimensionPixelOffset(R.styleable.RoundedImageView_label_offsettop, -1));
        mLabelOffsetBottom = Math.max(0,
                a.getDimensionPixelOffset(R.styleable.RoundedImageView_label_offsetbottom, -1));
        mLabelGravity = a.getInteger(R.styleable.RoundedImageView_label_gravity, GRAVITY_LEFT | GRAVITY_TOP);
        ...
        borderColor = a.getColor(R.styleable.RoundedImageView_border_color, RoundedDrawable.DEFAULT_BORDER_COLOR);
     ...
     *
     * @width width border width in pixels.
    ...
    private void initLabelOffset() {
        ...
        int viewW = getMeasuredWidth();
        int viewH = getMeasuredHeight();
        // label default align left/top
        if ((mLabelGravity & GRAVITY_CENTER_HORIZONTAL) != 0 || (mLabelGravity & GRAVITY_CENTER_VERTICAL) != 0) {
