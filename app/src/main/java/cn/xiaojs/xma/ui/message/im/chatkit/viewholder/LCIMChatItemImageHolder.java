...
import cn.xiaojs.xma.ui.message.im.chatkit.activity.LCIMImageActivity;
...
public class LCIMChatItemImageHolder extends LCIMChatItemHolder {
  ...
  public void initView() {
    ...
    if (isLeft) {
      contentView.setBackgroundResource(R.drawable.ic_chat_other);
    } else {
      contentView.setBackgroundResource(R.drawable.ic_chat_me);
    }
