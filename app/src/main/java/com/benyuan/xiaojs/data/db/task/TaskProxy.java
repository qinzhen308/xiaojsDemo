package com.benyuan.xiaojs.data.db.task;
            ...
            try {
                switch (msg.what) {
                    ...
                    case MSG_WHAT_ON_ERROR: {
                        ...
                        Logger.d(getClass().getName(),throwable.getMessage(), throwable);
                    ...
                    case MSG_WHAT_ON_CANCEL: {
                        ...
                        assert args != null;
                        taskProxy.task.onCancelled((com.benyuan.xiaojs.data.db.task.Callback.CancelledException) args[0]);
                        break;
                    }
