...
public abstract class PullToRefreshStickyAdapterViewBase<T extends StickyListHeadersListView>
	...
	private boolean mDisableAutoLoad = false;
	...
	public void setBottomAutoLoad(boolean auto) {
		mDisableAutoLoad = !auto;
	}
	...
	public final void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
		...
		mNeedNextPage = (totalItemCount > 0)
				&& (firstVisibleItem + visibleItemCount >= totalItemCount - (mDisableAutoLoad ? 1 : 2))
