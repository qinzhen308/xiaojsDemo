...
import static com.benyuan.xiaojs.common.permissiongen.internal.PermissionUtil.getActivity;
...
public class PermissionGen {
    ...
    private static void requestPermissions(Object object, int requestCode, String[] permissions) {
        ...
        List<String> deniedPermissions = PermissionUtil.findDeniedPermissions(getActivity(object), permissions);
