...
package com.benyuan.xiaojs.common.pulltorefresh.swipelistview;
...
public class SwipeListViewTouchListener implements View.OnTouchListener {
	...
	private float mRightDeleteWidth;
	...
	public SwipeListViewTouchListener(SwipeListView swipeListView,
									  int swipeFrontView, int swipeBackView, Context context) {
		...
		mRightDeleteWidth = context.getResources().getDimension(R.dimen.px140);
	}
