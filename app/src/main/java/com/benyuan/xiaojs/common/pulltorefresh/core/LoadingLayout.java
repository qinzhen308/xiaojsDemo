...
public abstract class LoadingLayout extends FrameLayout implements
	...
	public LoadingLayout(Context context, final PullToRefreshBase.Mode mode,
		...
		loadLayout(context, scrollDirection);
	...
	public void loadLayout(Context context, PullToRefreshBase.Orientation scrollDirection) {
	...
	public  void releaseToRefresh() {
		if (null != mHeaderText) {
			...
			resetHeaderTextMinSize(mReleaseLabel);
		}
	...
	protected void resetHeaderTextMinSize(CharSequence text) {
		if (!TextUtils.isEmpty(text)) {
			mHeaderText.setMinEms(6);
		} else {
			mHeaderText.setMinEms(0);
		}
	}
